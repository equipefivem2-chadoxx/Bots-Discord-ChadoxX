...
module.exports = {
    name: Events.ClientReady, // S'exécute au démarrage (quand le bot est "ready")
    once: true,
    async execute(client) {
        ...
        if (fs.existsSync(commandsPath)) {
            ...
            for (const file of commandFiles) {
                ...
                if ('data' in command && 'execute' in command) {
                    // On prépare les données de la commande pour l'API Discord
        ...
        try {
            ...
            // Cette ligne magique remplace complètement le script deploy-commands.js
            // Elle met à jour les commandes globalement pour ton bot
